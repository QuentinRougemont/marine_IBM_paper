...
folder1 = "png_mig_and_crash_north_54_pop/before"
folder2 = "png_mig_and_crash_north_54_pop/connectivity_change"
folder3 = "png_mig_and_crash_north_54_pop/connectivity_change_and_bottleneck"
folder4 = "png_mig_and_crash_north_54_pop/warming_time"
...
setwd(p3)
av::av_encode_video(list.files(p3, '*.png'), framerate = 05,
    output = nom3)
setwd(p4)
av::av_encode_video(list.files(p4, '*.png'), framerate = 05,
    output = nom3)
